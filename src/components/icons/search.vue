<template>
    <div class="search">
        <input class="search__input" type="Text" v-if="search">
        <svg @click="viewer" class="search__icon" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
